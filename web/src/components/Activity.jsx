...
const styles = {
  ...
  statusM: { background: '#854d0e', color: '#fef08a' },
  statusA: { background: '#166534', color: '#86efac' },
  statusD: { background: '#991b1b', color: '#fca5a5' },
  statusQ: { background: '#1e3a5f', color: '#93c5fd' },
  fileName: {
    overflow: 'hidden',
